<template><div><figure><img src="http://img.xiaogangzai.cn/16e05cfa4cbc2139.jpg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>说一下为什么写这个系列？</p>
<ul>
...
<p>先看一张整体的流程图</p>
<figure><img src="http://img.xiaogangzai.cn/article_01.jpg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>下面围绕这张图和不同代表性对例子进行讲解。</p>
<h2 id="html解析器" tabindex="-1"><a class="header-anchor" href="#html解析器"><span>HTML解析器</span></a></h2>
...
<div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>3C 62 6F ...</span></span></code></pre>
...
<figure><img src="http://img.xiaogangzai.cn/article_02.jpg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<figure><img src="http://img.xiaogangzai.cn/article_03.jpg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<ul>
...
<figure><img src="http://img.xiaogangzai.cn/article_04.jpg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<ul>
...
<figure><img src="http://img.xiaogangzai.cn/article.jpg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<ul>
...
<figure><img src="http://img.xiaogangzai.cn/article_06.jpg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<ul>
<li>最后按照上面的规则，分词器一路解析下来，就形成了这个简单的 DOM 树。</li>
</ul>
<figure><img src="http://img.xiaogangzai.cn/article_07.jpg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>此时应该搞懂了核心图中 HTML 解析器的部分，和 DOM 树的基本绘制流程，但是现实很残酷，哪里有这么简单的前端代码，还有有 JavaScript 和 CSS 呢！继续往下看</p>
<h2 id="css解析器" tabindex="-1"><a class="header-anchor" href="#css解析器"><span>CSS解析器</span></a></h2>
<p>CSS 解析器最终的目的也是构建树不过它构建的树是 CSSOM 树<br>
树的构建流程和 DOM 树的构建流程基本相同</p>
<figure><img src="http://img.xiaogangzai.cn/article_08.jpg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>还是那张图，具体我就不一一讲解一遍了。直接用这个简单例子</p>
...
<figure><img src="http://img.xiaogangzai.cn/article_09.jpg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<h2 id="javascript对dom树与cssom树创建的影响" tabindex="-1"><a class="header-anchor" href="#javascript对dom树与cssom树创建的影响"><span>javascript对DOM树与CSSOM树创建的影响</span></a></h2>
...
<figure><img src="http://img.xiaogangzai.cn/article_10.jpg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h2 id="构建渲染树" tabindex="-1"><a class="header-anchor" href="#构建渲染树"><span>构建渲染树</span></a></h2>
...
<figure><img src="http://img.xiaogangzai.cn/article_11.jpg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h2 id="本文渲染树形成过程可以做哪些优化" tabindex="-1"><a class="header-anchor" href="#本文渲染树形成过程可以做哪些优化"><span>本文渲染树形成过程可以做哪些优化</span></a></h2>
...
<p>觉得不错点个Star，欢迎 加群 互相学习。</p>
<figure><img src="http://img.xiaogangzai.cn/leading.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
</div></template>
