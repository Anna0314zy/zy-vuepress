...
hoistedDependencies:
  ...
  /@vitejs/plugin-vue/5.2.1_vite@5.0.13+vue@3.5.13:
  ...
  /@vuepress/plugin-medium-zoom/2.0.0-rc.74_vuepress@2.0.0-rc.19:
  ...
  /@vuepress/plugin-palette/2.0.0-rc.74_vuepress@2.0.0-rc.19:
    '@vuepress/plugin-palette': private
  /@vuepress/plugin-prismjs/2.0.0-rc.74_yicpmmebtevytzv4k2l6b7rwvq:
  ...
  /picomatch/2.3.1:
    picomatch: private
  /postcss-load-config/5.1.0_postcss@8.5.2:
...
pendingBuilds: []
prunedAt: Wed, 12 Feb 2025 11:10:12 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
